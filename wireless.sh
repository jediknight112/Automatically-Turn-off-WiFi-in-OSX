...
# For OSX 10.7 (#11) Lion and OSX 10.8 (#12) Mountain Lion and 10.9 (#13) Mavericks, Yosemite (#14), El Capitan (#15)
elif [ "$OSVERSION" == "11" -o "$OSVERSION" == "12" -o "$OSVERSION" == "13" -o "$OSVERSION" == "14" -o "$OSVERSION" == "15" ]; then
  if [ $IPFOUND ]; then
    /usr/sbin/networksetup -setairportpower $WIFIINTERFACES off || exit 1
